    ...
    <div class="row">
        ...
        <div class="tab-content  col-lg-6 col-md-6 col-sm-7 col-sm-offset-1 col-xs-12 col-md-offset-1 col-lg-offset-1">
            ...
            <div id="purpose" class="tab-pane fade panel panel-primary">
                ...
                <div class="panel-body">
                    <p>
                        Nova Southeastern Universityâ€™s (NSU) College of Engineering Internship Program provides an educational strategy whereby students complement their academic preparation with direct practical experience.
